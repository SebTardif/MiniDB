...
from .types import TokenType, ColumnType, QueryType
...
class Condition:
    ...
    value: Any
    table_alias: Optional[str] = None  # For JOIN column references
...
class Parser:
    ...
    def parse(self) -> Union[SelectQuery, InsertQuery, UpdateQuery, DeleteQuery, CreateTableQuery, DropTableQuery]:
    ...
    def _parse_condition(self) -> Condition:
        ...
        if self._match(TokenType.EQUALS):
            ...
            raise SyntaxError_(
                f"Expected comparison operator, got {self._current().type.name}",
    ...
    def _parse_value(self) -> Any:
        ...
        if token.type == TokenType.STRING_LITERAL:
            ...
            raise SyntaxError_(
                f"Expected literal value, got {token.type.name}",
                token.position
            )
...
def parse_sql(sql: str) -> Union[SelectQuery, InsertQuery, UpdateQuery, DeleteQuery, CreateTableQuery, DropTableQuery]:
