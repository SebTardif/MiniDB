...
class TypeMismatchError(TypeError_):
    ...
    def __init__(self, column_name: str, expected_type: str, actual_type: str):
        ...
        super().__init__(f"Type mismatch for column '{column_name}': expected {expected_type}, got {actual_type}")
...
class FileReadError(PersistenceError):
    ...
    def __init__(self, filepath: str, reason: str | None = None):
...
class VersionMismatchError(PersistenceError):
    ...
    def __init__(self, version: str, expected: str):
        ...
        super().__init__(f'Incompatible persistence file version: {version} (expected {expected})')
