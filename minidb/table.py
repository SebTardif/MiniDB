...
from .column import Schema, Column
...
class Table:
    ...
    def get_row_id_by_pk(self, pk_value: Any) -> Optional[int]:
    ...
    def get_rows_with_ids(self) -> list[tuple[int, Row]]:
        ...
        return [(row_id, row.copy()) for row_id, row in zip(self._row_ids, self._rows)]
    ...
    def scan(self) -> Iterator[tuple[int, Row]]:
        ...
        for row_id, row in zip(self._row_ids, self._rows):
